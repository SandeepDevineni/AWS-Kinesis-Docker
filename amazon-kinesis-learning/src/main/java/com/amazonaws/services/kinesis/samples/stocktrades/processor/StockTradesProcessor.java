 ...
 * records from the stock trades stream. KCL monitors the number of shards and creates record
 * processor instances to read and process records from each shard. KCL also load balances shards
 * across all the instances of this processor.
 */
public class StockTradesProcessor {
  ...
  private static void checkUsage(String[] args) {
    if (args.length != 3) {
      System.err.println(
          "Usage: "
              + StockTradesProcessor.class.getSimpleName()
  ...
  /**
   * Sets the global log level to WARNING and the log level for this package to INFO, so that we
   * only see INFO messages for this processor. This is just for the purpose of this tutorial, and
   * should not be considered as best practice.
   */
  ...
  public static void main(String[] args) throws Exception {
    ...
    String applicationName = "datascience-local-news";
    String streamName = "datascience-local-news";
